# Joel Dietz
  ...
  *Available for AI research consulting, speaking, and collaboration*
  ...
  [![X @jdietz](https://img.shields.io/badge/X-@jdietz-000000?style=flat-square&logo=x&logoColor=white)](https://x.com/jdietz)
  [![X @fractastical](https://img.shields.io/badge/X-@fractastical-000000?style=flat-square&logo=x&logoColor=white)](https://x.com/fractastical)

  **Quick links:**
  [📖 Publications](https://fractastical.org) · [💼 Works](https://fractastical.org) · [📄 Resume/CV](https://fractastical.org) · [💻 GitHub](https://github.com/fractastical) · [🎨 Art](https://fractastical.org) · [✍️ Writings](https://fractastical.org) · [🎙️ Talks](https://fractastical.org) · [🌐 Philosophy](https://fractastical.org) · [📬 Contact](https://fractastical.org)

  ---

  ## ~/  About — Computational Creativity & Digital Consciousness

  Joel Dietz studies **fractals**, **computational creativity**, and **machine consciousness** — building tools at the intersection of mathematics, code, and art. Available for **AI research consulting**, **speaking**, and **collaboration**.
  ...
  - 📚 **Writer & Philosopher** — Writings on distributed governance, consciousness, digital humanities
  ...
  |---------|------|-------------|
  | [**CIMC Philosophy Review**](https://cimcreview.com) | JOURNAL | Research on artificial sentience, active inference, and philosophy of mind |
  ...
  > 🌀 *Lover of fractals, code, poetry, morphospace, artificial life, consciousness.*

  📍 Palo Alto &nbsp;|&nbsp; 🏛️ [@cimcai](https://github.com/cimcai) — California Institute of Machine Consciousness &nbsp;|&nbsp; 🌐 [fractastical.org](https://fractastical.org)
